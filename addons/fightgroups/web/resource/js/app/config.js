require.config({
	baseUrl: '../addons/fightgroups/web/resource/js/app',
	paths: {
...
//		'wapeditor' : 'wapeditor.min'
	...
	shim:{
		...
		'select2': {
			deps: ['css!../../components/select2/select2.min.css', '../addons/fightgroups/web/resource/components/select2/select2.min.js']
		},
		'clockpicker': {
			exports: "$",
