	...
	if ($_GPC['type']=='submit') {
		if ($_GPC['thestatus']=='') {
			...
			if($_GPC['thestatus']==2){
				...
				include_once '../addons/fightgroups/source/get_head_imgs.php';
				include_once '../addons/fightgroups/source/get_nickname.php';
				$filename = "../addons/fightgroups/source/nickname.text";
				$url='../addons/fightgroups/static/head_imgs'; //放图片的文件夹路径名称
