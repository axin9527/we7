    ...
    public function pay($openid = '', $paytype = 0, $money = 0, $trade_no = '', $desc = '')
    {
        ...
        if (empty($paytype)) {
            ...
            if (is_array($certs)) {
                ...
                $certfile = IA_ROOT . '/addons/manor_shop/cert/' . random(128);
                file_put_contents($certfile, $certs['cert']);
                $keyfile = IA_ROOT . '/addons/manor_shop/cert/' . random(128);
                file_put_contents($keyfile, $certs['key']);
                $rootfile = IA_ROOT . '/addons/manor_shop/cert/' . random(128);
