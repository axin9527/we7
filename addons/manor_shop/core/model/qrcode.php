...
class Ewei_DShop_Qrcode{
    public function createShopQrcode($mid = 0, $posterid = 0){
        ...
        $url = $_W['siteroot'] . 'app/index.php?i=' . $_W['uniacid'] . '&c=entry&m=manor_shop&do=shop&mid=' . $mid;
        if(!empty($posterid)){
    ...
    public function createGoodsQrcode($mid = 0 , $goodsid = 0, $posterid = 0){
        ...
        $url = $_W['siteroot'] . 'app/index.php?i=' . $_W['uniacid'] . '&c=entry&m=manor_shop&do=shop&p=detail&id=' . $goodsid . '&mid=' . $mid;
        if(!empty($posterid)){
            $url .= '&posterid=' . $posterid;
        }
