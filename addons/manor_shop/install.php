...
DROP TABLE IF EXISTS `ims_manor_shop_adv`;
CREATE TABLE `ims_manor_shop_adv` (
...
-- ----------------------------
-- Records of ims_manor_shop_adv
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_article`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_article`;
CREATE TABLE `ims_manor_shop_article` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_manor_shop_article
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_article_category`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_article_category`;
CREATE TABLE `ims_manor_shop_article_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_manor_shop_article_category
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_article_category_copy`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_article_category_copy`;
CREATE TABLE `ims_manor_shop_article_category_copy` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `category_name` varchar(255) NOT NULL DEFAULT '' COMMENT '分类名称',
  `uniacid` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
-- ----------------------------
-- Records of ims_manor_shop_article_category_copy
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_article_log`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_article_log`;
CREATE TABLE `ims_manor_shop_article_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM AUTO_INCREMENT=261 DEFAULT CHARSET=utf8 COMMENT='点赞/阅读记录';

-- ----------------------------
-- Records of ims_manor_shop_article_log
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_article_report`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_article_report`;
CREATE TABLE `ims_manor_shop_article_report` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_manor_shop_article_report
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_article_share`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_article_share`;
CREATE TABLE `ims_manor_shop_article_share` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `idx_aid` (`aid`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='用户分享数据';

-- ----------------------------
-- Records of ims_manor_shop_article_share
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_article_sys`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_article_sys`;
CREATE TABLE `ims_manor_shop_article_sys` (
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_article_sys
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_carrier`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_carrier`;
CREATE TABLE `ims_manor_shop_carrier` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_carrier
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_category`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_category`;
CREATE TABLE `ims_manor_shop_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_manor_shop_category
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_commission_apply`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_commission_apply`;
CREATE TABLE `ims_manor_shop_commission_apply` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_commission_apply
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_commission_clickcount`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_commission_clickcount`;
CREATE TABLE `ims_manor_shop_commission_clickcount` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_commission_clickcount
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_commission_level`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_commission_level`;
CREATE TABLE `ims_manor_shop_commission_level` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_manor_shop_commission_level
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_commission_log`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_commission_log`;
CREATE TABLE `ims_manor_shop_commission_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_commission_log
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_commission_shop`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_commission_shop`;
CREATE TABLE `ims_manor_shop_commission_shop` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `mid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_commission_shop
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_coupon`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_coupon`;
CREATE TABLE `ims_manor_shop_coupon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_coupon
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_coupon_category`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_coupon_category`;
CREATE TABLE `ims_manor_shop_coupon_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(255) DEFAULT '',
  `displayorder` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_coupon_category
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_coupon_data`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_coupon_data`;
CREATE TABLE `ims_manor_shop_coupon_data` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
-- ----------------------------
-- Records of ims_manor_shop_coupon_data
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_coupon_guess`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_coupon_guess`;
CREATE TABLE `ims_manor_shop_coupon_guess` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `couponid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
-- ----------------------------
-- Records of ims_manor_shop_coupon_guess
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_coupon_log`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_coupon_log`;
CREATE TABLE `ims_manor_shop_coupon_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_coupon_log
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_creditshop_adv`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_creditshop_adv`;
CREATE TABLE `ims_manor_shop_creditshop_adv` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `advname` varchar(50) DEFAULT '',
  `link` varchar(255) DEFAULT '',
...
-- ----------------------------
-- Records of ims_manor_shop_creditshop_adv
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_creditshop_category`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_creditshop_category`;
CREATE TABLE `ims_manor_shop_creditshop_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0' COMMENT '所属帐号',
  `name` varchar(50) DEFAULT NULL COMMENT '分类名称',
  `thumb` varchar(255) DEFAULT NULL COMMENT '分类图片',
...
-- ----------------------------
-- Records of ims_manor_shop_creditshop_category
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_creditshop_goods`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_creditshop_goods`;
CREATE TABLE `ims_manor_shop_creditshop_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `displayorder` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_creditshop_goods
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_creditshop_log`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_creditshop_log`;
CREATE TABLE `ims_manor_shop_creditshop_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `logno` varchar(255) DEFAULT '',
...
-- ----------------------------
-- Records of ims_manor_shop_creditshop_log
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_designer`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_designer`;
CREATE TABLE `ims_manor_shop_designer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_manor_shop_designer
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_designer_menu`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_designer_menu`;
CREATE TABLE `ims_manor_shop_designer_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_designer_menu
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_dispatch`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_dispatch`;
CREATE TABLE `ims_manor_shop_dispatch` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_dispatch
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_diyform_category`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_diyform_category`;
CREATE TABLE `ims_manor_shop_diyform_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0' COMMENT '所属帐号',
  `name` varchar(50) DEFAULT NULL COMMENT '分类名称',
  PRIMARY KEY (`id`),
...
-- ----------------------------
-- Records of ims_manor_shop_diyform_category
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_diyform_data`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_diyform_data`;
CREATE TABLE `ims_manor_shop_diyform_data` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_diyform_data
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_diyform_temp`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_diyform_temp`;
CREATE TABLE `ims_manor_shop_diyform_temp` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_diyform_temp
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_diyform_type`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_diyform_type`;
CREATE TABLE `ims_manor_shop_diyform_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `cate` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_diyform_type
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_exhelper_express`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_exhelper_express`;
CREATE TABLE `ims_manor_shop_exhelper_express` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_exhelper_express
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_exhelper_senduser`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_exhelper_senduser`;
CREATE TABLE `ims_manor_shop_exhelper_senduser` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_exhelper_senduser
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_exhelper_sys`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_exhelper_sys`;
CREATE TABLE `ims_manor_shop_exhelper_sys` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_exhelper_sys
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_express`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_express`;
CREATE TABLE `ims_manor_shop_express` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_express
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_feedback`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_feedback`;
CREATE TABLE `ims_manor_shop_feedback` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_feedback
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_goods`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_goods`;
CREATE TABLE `ims_manor_shop_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_goods
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_goods_comment`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_goods_comment`;
CREATE TABLE `ims_manor_shop_goods_comment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_goods_comment
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_goods_option`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_goods_option`;
CREATE TABLE `ims_manor_shop_goods_option` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `goodsid` int(10) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_goods_option
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_goods_param`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_goods_param`;
CREATE TABLE `ims_manor_shop_goods_param` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `goodsid` int(10) DEFAULT '0',
  `title` varchar(50) DEFAULT '',
...
-- ----------------------------
-- Records of ims_manor_shop_goods_param
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_goods_spec`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_goods_spec`;
CREATE TABLE `ims_manor_shop_goods_spec` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `goodsid` int(11) DEFAULT '0',
  `title` varchar(50) DEFAULT '',
...
-- ----------------------------
-- Records of ims_manor_shop_goods_spec
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_goods_spec_item`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_goods_spec_item`;
CREATE TABLE `ims_manor_shop_goods_spec_item` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_goods_spec_item
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_member`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_member`;
CREATE TABLE `ims_manor_shop_member` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_member
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_member_address`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_member_address`;
CREATE TABLE `ims_manor_shop_member_address` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(50) DEFAULT '0',
  `realname` varchar(20) DEFAULT '',
...
-- ----------------------------
-- Records of ims_manor_shop_member_address
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_member_cart`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_member_cart`;
CREATE TABLE `ims_manor_shop_member_cart` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_member_cart
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_member_favorite`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_member_favorite`;
CREATE TABLE `ims_manor_shop_member_favorite` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `goodsid` int(10) DEFAULT '0',
  `openid` varchar(50) DEFAULT '',
...
-- ----------------------------
-- Records of ims_manor_shop_member_favorite
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_member_group`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_member_group`;
CREATE TABLE `ims_manor_shop_member_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_member_group
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_member_history`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_member_history`;
CREATE TABLE `ims_manor_shop_member_history` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `goodsid` int(10) DEFAULT '0',
  `openid` varchar(50) DEFAULT '',
...
-- ----------------------------
-- Records of ims_manor_shop_member_history
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_member_level`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_member_level`;
CREATE TABLE `ims_manor_shop_member_level` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `level` int(11) DEFAULT '0',
  `levelname` varchar(50) DEFAULT '',
...
-- ----------------------------
-- Records of ims_manor_shop_member_level
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_member_log`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_member_log`;
CREATE TABLE `ims_manor_shop_member_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
-- ----------------------------
-- Records of ims_manor_shop_member_log
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_member_message_template`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_member_message_template`;
CREATE TABLE `ims_manor_shop_member_message_template` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
...
-- ----------------------------
-- Records of ims_manor_shop_member_message_template
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_notice`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_notice`;
CREATE TABLE `ims_manor_shop_notice` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `displayorder` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
...
-- ----------------------------
-- Records of ims_manor_shop_notice
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_order`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_order`;
CREATE TABLE `ims_manor_shop_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(50) DEFAULT '',
  `agentid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_order
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_order_comment`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_order_comment`;
CREATE TABLE `ims_manor_shop_order_comment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_order_comment
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_order_goods`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_order_goods`;
CREATE TABLE `ims_manor_shop_order_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `orderid` int(11) DEFAULT '0',
  `goodsid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_order_goods
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_order_refund`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_order_refund`;
CREATE TABLE `ims_manor_shop_order_refund` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `orderid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_order_refund
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_perm_log`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_perm_log`;
CREATE TABLE `ims_manor_shop_perm_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT '0',
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(255) DEFAULT '',
...
-- ----------------------------
-- Records of ims_manor_shop_perm_log
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_perm_plugin`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_perm_plugin`;
CREATE TABLE `ims_manor_shop_perm_plugin` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_manor_shop_perm_plugin
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_perm_role`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_perm_role`;
CREATE TABLE `ims_manor_shop_perm_role` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_perm_role
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_perm_user`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_perm_user`;
CREATE TABLE `ims_manor_shop_perm_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `uid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_perm_user
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_plugin`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_plugin`;
CREATE TABLE `ims_manor_shop_plugin` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `displayorder` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_plugin
-- ----------------------------
INSERT INTO `ims_manor_shop_plugin` VALUES ('1', '1', 'qiniu', '七牛存储', '1.0', '官方', '1', 'tool');
INSERT INTO `ims_manor_shop_plugin` VALUES ('2', '2', 'taobao', '淘宝助手', '1.0', '官方', '1', 'tool');
INSERT INTO `ims_manor_shop_plugin` VALUES ('3', '3', 'commission', '人人分销', '1.0', '官方', '1', 'biz');
INSERT INTO `ims_manor_shop_plugin` VALUES ('4', '4', 'poster', '超级海报', '1.2', '官方', '1', 'sale');
INSERT INTO `ims_manor_shop_plugin` VALUES ('5', '5', 'verify', 'O2O核销', '1.0', '官方', '1', 'biz');
INSERT INTO `ims_manor_shop_plugin` VALUES ('6', '6', 'tmessage', '会员群发', '1.0', '官方', '1', 'tool');
INSERT INTO `ims_manor_shop_plugin` VALUES ('7', '7', 'perm', '分权系统', '1.0', '官方', '0', 'help');
INSERT INTO `ims_manor_shop_plugin` VALUES ('8', '8', 'sale', '营销宝', '1.0', '官方', '0', 'sale');
INSERT INTO `ims_manor_shop_plugin` VALUES ('9', '9', 'creditshop', '积分商城', '1.0', '官方', '0', 'biz');
INSERT INTO `ims_manor_shop_plugin` VALUES ('10', '10', 'virtual', '虚拟物品', '1.0', '官方', '0', 'biz');
INSERT INTO `ims_manor_shop_plugin` VALUES ('11', '11', 'coupon', '超级券', '1.0', '官方', '0', 'sale');
INSERT INTO `ims_manor_shop_plugin` VALUES ('12', '12', 'designer', '店铺装修', '1.0', '官方', '0', 'help');
INSERT INTO `ims_manor_shop_plugin` VALUES ('13', '13', 'postera', '活动海报', '1.0', '官方', '0', 'sale');
INSERT INTO `ims_manor_shop_plugin` VALUES ('14', '14', 'system', '系统工具', '1.0', '官方', '0', 'help');
INSERT INTO `ims_manor_shop_plugin` VALUES ('15', '15', 'exhelper', '快递助手', '1.0', '官方', '0', 'help');
INSERT INTO `ims_manor_shop_plugin` VALUES ('16', '16', 'article', '文章营销', '1.0', '官方', '1', 'help');
INSERT INTO `ims_manor_shop_plugin` VALUES ('17', '17', 'diyform', '自定义表单', '1.0', '官方', '1', 'help');

-- ----------------------------
-- Table structure for `ims_manor_shop_poster`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_poster`;
CREATE TABLE `ims_manor_shop_poster` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_poster
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_postera`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_postera`;
CREATE TABLE `ims_manor_shop_postera` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `type` tinyint(3) DEFAULT '0' COMMENT '1 首页 2 小店 3 商城 4 自定义',
...
-- ----------------------------
-- Records of ims_manor_shop_postera
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_postera_log`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_postera_log`;
CREATE TABLE `ims_manor_shop_postera_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
-- ----------------------------
-- Records of ims_manor_shop_postera_log
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_postera_qr`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_postera_qr`;
CREATE TABLE `ims_manor_shop_postera_qr` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_manor_shop_postera_qr
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_poster_log`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_poster_log`;
CREATE TABLE `ims_manor_shop_poster_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
  `posterid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_poster_log
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_poster_qr`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_poster_qr`;
CREATE TABLE `ims_manor_shop_poster_qr` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `acid` int(10) unsigned NOT NULL,
  `openid` varchar(100) NOT NULL DEFAULT '',
  `type` tinyint(3) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_poster_qr
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_poster_scan`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_poster_scan`;
CREATE TABLE `ims_manor_shop_poster_scan` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `posterid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
-- ----------------------------
-- Records of ims_manor_shop_poster_scan
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_refund_address`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_refund_address`;
CREATE TABLE `ims_manor_shop_refund_address` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_refund_address
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_saler`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_saler`;
CREATE TABLE `ims_manor_shop_saler` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `storeid` int(11) DEFAULT '0',
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
-- ----------------------------
-- Records of ims_manor_shop_saler
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_store`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_store`;
CREATE TABLE `ims_manor_shop_store` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of ims_manor_shop_store
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_sysset`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_sysset`;
CREATE TABLE `ims_manor_shop_sysset` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `sets` text,
  `plugins` text,
...
-- ----------------------------
-- Records of ims_manor_shop_sysset
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_system_copyright`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_system_copyright`;
CREATE TABLE `ims_manor_shop_system_copyright` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_manor_shop_system_copyright
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_virtual_category`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_virtual_category`;
CREATE TABLE `ims_manor_shop_virtual_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0' COMMENT '所属帐号',
  `name` varchar(50) DEFAULT NULL COMMENT '分类名称',
  PRIMARY KEY (`id`),
...
-- ----------------------------
-- Records of ims_manor_shop_virtual_category
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_virtual_data`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_virtual_data`;
CREATE TABLE `ims_manor_shop_virtual_data` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `typeid` int(11) NOT NULL DEFAULT '0' COMMENT '类型id',
...
-- ----------------------------
-- Records of ims_manor_shop_virtual_data
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_manor_shop_virtual_type`
-- ----------------------------
DROP TABLE IF EXISTS `ims_manor_shop_virtual_type`;
CREATE TABLE `ims_manor_shop_virtual_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `cate` int(11) DEFAULT '0',
  `title` varchar(255) NOT NULL DEFAULT '' COMMENT '分类名称',
...
-- ----------------------------
-- Records of ims_manor_shop_virtual_type
-- ----------------------------
