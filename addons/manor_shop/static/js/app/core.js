...
define(['jquery', 'core'], function($, core) {
    ...
    var core = {
        ...
        default_options: {
            baseUrl: '',
            siteUrl: '',
            staticUrl: '../addons/manor_shop/static/'
        },
        options: {},
    };
      ...
      core.loading =  function() {
          var u = navigator.userAgent, app = navigator.appVersion;
           if ($('#core_loading').length <= 0) {
                $('body').append('<div id="core_loading" style="top:50%;left:50%;margin-left:-35px;margin-top:-30px;position:absolute;width:80px;z-index:999999"><img src="../addons/manor_shop/static/images/loading.svg" width="80" /></div>')
            }
            else{
                $('#core_loading').show();
            }
    ...
    core.tip = {
        show: function(msg, position, duration) {
           ...
           if(position!='bottom' && position!='middle' && position!='top'){
            ...
            html+='</div></div></div>';*/
            var html = '<div id="core_alert" class="add_ok"><div class="layer"></div><div class="tips"><div class="msg">';
            html+=msg;
            html+='</div><div class=" button_items"><nav data-action="cancel" class="ok_button_left">取消</nav><nav class="ok_button_right" data-action="ok">确定</nav>';
            html+='</div></div></div>';
           ...
           $(document.body).append(div);
            ...
            html+='</div></div></div>';*/
            var html = '<div id="core_alert" id="add_ok"><div class="layer"></div><div class="tips"><div class="msg">';
            html+=msg;
            html+='</div><div class="button_items"><nav data-action="ok" class="ok_button_center">确定</nav>';
            html+='</div></div></div>';
        ...
        },alert2: function (msg,tips_1, tips_2, url_1, url_2) {
            var html = '<div><div class="add_ok2"><div class="msg">'+msg+'</div><div class="button_items"><a href="'+url_1+'" class="ok_button_left">'+tips_1+'</a><a style="" href="'+url_2+'" class="ok_button_right">'+tips_2+'</a> </div> </div></div>';
