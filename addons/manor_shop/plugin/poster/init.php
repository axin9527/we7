...
if (!pdo_tableexists('manor_shop_poster')) {
	$sql = 'CREATE TABLE IF NOT EXISTS ' . tablename('manor_shop_poster') . ' (
	...
	pdo_query($sql);
	$sql = 'CREATE TABLE IF NOT EXISTS ' . tablename('manor_shop_poster_log') . ' (
	      `id` int(11) NOT NULL AUTO_INCREMENT,
	      `uniacid` int(11) DEFAULT \'0\',
	...
	pdo_query($sql);
	$sql = 'CREATE TABLE  IF NOT EXISTS ' . tablename('manor_shop_poster_qr') . ' (
	      `id` int(11) NOT NULL AUTO_INCREMENT,
	...
	$sql = 'CREATE TABLE  IF NOT EXISTS  ' . tablename('manor_shop_poster_scan') . ' (
	      `id` int(11) NOT NULL AUTO_INCREMENT,
	      `uniacid` int(11) DEFAULT \'0\',
	      `posterid` int(11) DEFAULT \'0\',
	      `openid` varchar(255) DEFAULT \'\',
...
if (!pdo_fieldexists('manor_shop_poster', 'paytype')) {
	pdo_query('ALTER TABLE ' . tablename('manor_shop_poster') . ' ADD `paytype` tinyint(1) DEFAULT \'0\';');
}
pdo_update('manor_shop_plugin', array('version' => 1.1), array('identity' => 'poster'));