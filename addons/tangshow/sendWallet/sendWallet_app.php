...
class walletWeixinUtil
{
    ...
    public static function curl_post_ssl($url, $vars, $second=30,$aHeader=array())
    {
        ...
        curl_setopt($ch,CURLOPT_SSLCERT,  SEND_WALLET."/cert/apiclient_cert.pem");
        //默认格式为PEM，可以注释
        curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
        curl_setopt($ch,CURLOPT_SSLKEY, SEND_WALLET."/cert/apiclient_key.pem");

         curl_setopt($ch,CURLOPT_CAINFO, SEND_WALLET."/cert/rootca.pem" );
