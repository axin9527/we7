<?php
$sql = "
drop table  if exists `ims_lucky_wheel_award`;
drop table  if exists `ims_lucky_wheel_fans`;
drop table  if exists `ims_lucky_wheel_data`;
drop table  if exists `ims_lucky_wheel_reply`;
drop table  if exists `ims_lucky_wheel_share`;
drop table  if exists `ims_lucky_wheel_prize`;
";
$sqlnews = "
CREATE TABLE IF NOT EXISTS `ims_lucky_wheel_reply` (
...
CREATE TABLE IF NOT EXISTS `ims_lucky_wheel_exchange` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `rid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '规则id',
  `uniacid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公众号ID',
...
CREATE TABLE IF NOT EXISTS `ims_lucky_wheel_template` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公众号ID',
...
CREATE TABLE IF NOT EXISTS `ims_lucky_wheel_tmplmsg` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公众号ID',
...
CREATE TABLE IF NOT EXISTS `ims_lucky_wheel_share` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `rid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '规则id',
  `uniacid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公众号ID',
...
CREATE TABLE IF NOT EXISTS `ims_lucky_wheel_prize` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `rid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '规则id',
  `uniacid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公众号ID',
...
CREATE TABLE IF NOT EXISTS `ims_lucky_wheel_prizemika` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `rid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '规则id',
  `uniacid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公众号ID',
...
CREATE TABLE IF NOT EXISTS `ims_lucky_wheel_fans` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `rid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '规则id',
  `uniacid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公众号ID',
  `from_user` varchar(50) NOT NULL DEFAULT '' COMMENT '用户openid',
...
CREATE TABLE IF NOT EXISTS `ims_lucky_wheel_fansaward` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `rid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '规则id',
  `uniacid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公众号ID',
...
CREATE TABLE IF NOT EXISTS `ims_lucky_wheel_fanstmplmsg` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `rid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '规则id',
  `uniacid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公众号ID',
  `from_user` varchar(50) DEFAULT '0' COMMENT '用户openid',
...
CREATE TABLE IF NOT EXISTS `ims_lucky_wheel_sharedata` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `rid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '规则id',
  `uniacid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公众号ID',
...
$sql_fanstmplmsg = "CREATE TABLE IF NOT EXISTS `ims_lucky_wheel_fanstmplmsg` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `rid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '规则id',
  `uniacid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公众号ID',
  `from_user` varchar(50) DEFAULT '0' COMMENT '用户openid',
...
if(!pdo_fieldexists('lucky_wheel_reply', 'power')) {
	pdo_run($sql);
    pdo_run($sqlnews);
}
if(!pdo_fieldexists('lucky_wheel_reply', 'tips')) {
	pdo_query("ALTER TABLE ".tablename('lucky_wheel_reply')." ADD `tips` varchar(200) DEFAULT '' COMMENT '活动次数提示' AFTER `notprizetext`;");
}
if(!pdo_fieldexists('lucky_wheel_reply', 'number_times_tips')) {
	pdo_query("ALTER TABLE ".tablename('lucky_wheel_reply')." ADD `number_times_tips` varchar(100) DEFAULT '' COMMENT '超过总次数提示' AFTER `number_times`;");
}
if(!pdo_fieldexists('lucky_wheel_reply', 'day_number_times_tips')) {
	pdo_query("ALTER TABLE ".tablename('lucky_wheel_reply')." ADD `day_number_times_tips` varchar(100) DEFAULT '' COMMENT '超过每天次数提示' AFTER `day_number_times`;");
}
if(!pdo_fieldexists('lucky_wheel_reply', 'award_num_tips')) {
	pdo_query("ALTER TABLE ".tablename('lucky_wheel_reply')." ADD `award_num_tips` varchar(100) DEFAULT '' COMMENT '超过中奖数量提示' AFTER `award_num`;");
}
if(!pdo_fieldexists('lucky_wheel_exchange', 'before')) {
	pdo_query("ALTER TABLE ".tablename('lucky_wheel_exchange')." ADD `before` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '兑奖资料活动前还是中奖后1前2为后' AFTER `baidumaplat`;");
}else{
	pdo_run($sql_fanstmplmsg);
}
if(pdo_fieldexists('lucky_wheel_share', 'sharenum')) {
	pdo_query("ALTER TABLE ".tablename('lucky_wheel_share')." change `sharenum` `sharenum` varchar(5) DEFAULT '0' COMMENT '分享赠送礼盒基数';");
}
if(!pdo_fieldexists('lucky_wheel_reply', 'msgadpic')) {
	pdo_query("ALTER TABLE ".tablename('lucky_wheel_reply')." ADD `msgadpic` varchar(1000) DEFAULT '' COMMENT '消息提示广告图' AFTER `notprizetext`;");
}
if(!pdo_fieldexists('lucky_wheel_reply', 'msgadpictime')) {
	pdo_query("ALTER TABLE ".tablename('lucky_wheel_reply')." ADD `msgadpictime` tinyint(1) unsigned NOT NULL DEFAULT '5' COMMENT '消息提示时效' AFTER `msgadpic`;");
}
if(!pdo_fieldexists('lucky_wheel_reply', 'othermodule')) {
	pdo_query("ALTER TABLE ".tablename('lucky_wheel_reply')." ADD `othermodule` varchar(50) DEFAULT '' COMMENT '其他模块' AFTER `opportunity_txt`;");
}