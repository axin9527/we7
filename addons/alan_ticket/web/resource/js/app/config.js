require.config({
	baseUrl: '../addons/alan_ticket/web/resource/js/app',
	paths: {
...
//		'wapeditor' : 'wapeditor.min'
	...
	shim:{
		...
		'select2': {
			deps: ['css!../../components/select2/select2.min.css', '../addons/alan_ticket/web/resource/components/select2/select2.min.js']
		},
		'clockpicker': {
			exports: "$",
