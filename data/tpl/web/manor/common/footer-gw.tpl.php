<?php defined('IN_IA') or exit('Access Denied');?>			</div>
		...
		<div class="center-block footer animated fadeInUp" style="background: #222 !important;" role="footer">
			<div class="text-center">
                <?php  if(empty($_W['setting']['copyright']['footerright'])) { ?><a href="http://fresh.tangshengmanor.com">关于唐盛庄园</a>&nbsp;&nbsp;<a href="http://fresh.tangshengmanor.com">唐盛庄园官网</a>&nbsp;&nbsp;<a href="#">联系客服</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerright'];?><?php  } ?><?php  if(!empty($_W['setting']['copyright']['statcode'])) { ?><?php  echo $_W['setting']['copyright']['statcode'];?><?php  } ?>
			</div>
			<div class="text-center">
                <?php  if(empty($_W['setting']['copyright']['footerleft'])) { ?>Powered by <a href="http://fresh.tangshengmanor.com"><b>唐盛庄园技术组</b></a> v<?php echo IMS_VERSION;?> &copy; 2014-2016 <a href="http://fresh.tangshengmanor.com">fresh.tangshengmanor.com</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerleft'];?><?php  } ?>
			</div>
		</div>
	</div>
