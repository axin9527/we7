    ...
    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" >
        ...
        <div class="panel panel-default">
            ...
            <div class='panel-body'>  
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">商城搜索词</label>
                    <div class="col-sm-9 col-xs-12">
                        <?php if(cv('sysset.save.shop')) { ?>
                        <textarea name="shop[search]" class="form-control richtext" cols="70" rows="5"><?php  echo $set['shop']['search'];?></textarea>
                        <?php  } else { ?>
                        <textarea name="shop[search]" class="form-control richtext" cols="70" style="display:none"  rows="5"><?php  echo $set['shop']['search'];?></textarea>
                        <div class='form-control-static'><?php  echo $set['shop']['search'];?></div>
                        <?php  } ?>
                        <span class='help-block show_h'>商城首页搜索显示的热门搜索词设置,这里填写将在首页的搜索时候显示,<b style="color:red;">多个使用回车换行键分开</b></span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <?php  } else { ?>
                        <textarea name="shop[diycode]" class="form-control richtext" cols="70" style="display:none"
                                  rows="5"><?php  echo $set['shop']['diycode'];?></textarea>
