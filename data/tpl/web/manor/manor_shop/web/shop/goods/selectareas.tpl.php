...
<style type='text/css'>
 ...
 <div id="modal-areas2"  class="modal fade" tabindex="-1">
    ...
    function selectAreas1(){
        ...
        $('#btnSubmitArea').unbind('click').click(function(){
           $('.city:checked').each(function(){
               if(jQuery.inArray($(this).attr('city'), new_city_arr) == -1) {
                   new_city_arr.push($(this).attr('city'));
                   citystrs1+= $(this).attr('city') +";";
               }
           });
            console.log(citystrs1);
            $('#areas_value').html(citystrs1);
           $(".selectedareas").val(citystrs1);
        })
    };
