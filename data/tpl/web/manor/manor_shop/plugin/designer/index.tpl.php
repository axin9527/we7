                    ...
                    <div class="fe-phone-main">
                        <div id="editor">
                            <div ng-repeat="page in pages">
                                <div ng-include="'../addons/manor_shop/plugin/designer/template/temp/show-'+page.temp+'.html'" id="{{page.id}}" mid="{{page.id}}" ng-click="setfocus(page.id,$event)"></div>
                            </div>
                            ...
                            <div ng-repeat="Item in Items" class="fe-mod-repeat" ng-mouseover="over(Item.id)" ng-mouseleave="out(Item.id)">
                                ...
                                <div ng-include="'../addons/manor_shop/plugin/designer/template/temp/show-'+Item.temp+'.html'" class="fe-mod-parent" id="{{Item.id}}" ng-show="Item" mid="{{Item.id}}" on-finish-render-filters></div>
                            ...
                            <div class="fe-floatico" ng-show="pages[0].params.floatico==1" ng-style="{'width':pages[0].params.floatwidth,'top':pages[0].params.floattop}" ng-class="{'fe-floatico-right':pages[0].params.floatstyle=='right'}">
                                <img ng-src="{{pages[0].params.floatimg || '../addons/manor_shop/plugin/designer/template/imgsrc/init-data/init-image-7.png'}}" style="height:100%; width: 100%;" ng-click="setfocus('M0000000000000')" />
                            </div>
                            <!-- 关注按钮 -->
                            <div class="fe-guide" ng-click="setfocus('M0000000000000')" ng-show="pages[0].params.guide==1" ng-style="{'display':'block','background-color':pages[0].params.guidebgcolor,'top':'60px','z-index':'890','opacity':pages[0].params.guideopacity}">
                                <div class="fe-guide-faceimg"><img ng-src="../addons/manor_shop/plugin/designer/template/imgsrc/init-data/init-icon.png" ng-style="{'border-radius':pages[0].params.guidefacestyle}" /></div>
...
<script type="text/javascript" src="../addons/manor_shop/plugin/designer/template/imgsrc/angular-ueditor.js"></script>
    ...
    myModel.controller('FoxController', ['$scope', function($scope){
            $scope.navs = [
                ...
                {id:'banner',name:'轮播',params:{shape:'',align:'center',scroll:'2',bgcolor:''},
                   data:[
                       {id:'B0000000000001',imgurl:'../addons/manor_shop/plugin/designer/template/imgsrc/init-data/init-image-3.jpg',hrefurl:'http://www.baidu.com',sysurl:'url',},
                       {id:'B0000000000002',imgurl:'../addons/manor_shop/plugin/designer/template/imgsrc/init-data/init-image-2.jpg',hrefurl:'http://www.qq.com',sysurl:'url'},
                       {id:'B0000000000003',imgurl:'../addons/manor_shop/plugin/designer/template/imgsrc/init-data/init-image-6.jpg',hrefurl:'http://www.sina.com',sysurl:'url'}
                   ]
                },
                ...
                {id:'shop',name:'店招',params:{style:'1',bgimg:'../addons/manor_shop/plugin/designer/template/imgsrc/init-data/init-image-1.jpg',logo:'1',name:'1',menu:'1',navcolor:''},
                ...
                {id:'picture',name:'单图',params:{},data:[{id:'P0000000000001',imgurl:'../addons/manor_shop/plugin/designer/template/imgsrc/init-data/init-image-4.jpg',hrefurl:'',option:'0'}]},
