    ...
    <div class="col-sm-9 col-xs-12 chks">
       <?php if( ce('shop.goods' ,$item) ) { ?>
        <div class='input-group'>
            <input type="hidden" name="saler" maxlength="30" value="<?php  if(is_array($salers)) { foreach($salers as $saler) { ?> <?php  echo $saler['nickname'];?>; <?php  } } ?>" id="saler" class="form-control" readonly />
